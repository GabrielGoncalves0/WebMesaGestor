...
//        public async Task<Response<IEnumerable<PedidoDTO>>> ListarPedidos()
//        {
//            Response<IEnumerable<PedidoDTO>> resposta = new Response<IEnumerable<PedidoDTO>>();
//            try
//            {
...
//        public async Task<Response<PedidoDTO>> PedidoPorId(Guid id)
//        {
//            Response<PedidoDTO> resposta = new Response<PedidoDTO>();
//            try
//            {
...
//        public async Task<Response<PedidoDTO>> CriarPedido(PedCriacaoDTO pedido)
//        {
//            Response<PedidoDTO> resposta = new Response<PedidoDTO>();
//            try
//            {
...
//        public async Task<Response<PedidoDTO>> AtualizarPedido(PedEdicaoDTO pedido)
//        {
//            Response<PedidoDTO> resposta = new Response<PedidoDTO>();
//            try
//            {
